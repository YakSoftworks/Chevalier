...
void GeometryMaterial::createPipeline(RenderPassManager* renderPass, VkShaderModule vertShaderModule, VkShaderModule fragShaderModule, uint32_t subpass)
{
...
#pragma endregion
    ...
    std::array<VkPipelineColorBlendAttachmentState, 2> gColorBlendStates = { colorBlendAttachment, colorBlendAttachment };
    ...
    colorBlending.pAttachments = gColorBlendStates.data();
